...
class TestDistribution(unittest.TestCase):
    ...
    def test_none(self):
        ...
        self.assertRaisesRegex(ValueError, PARAM_ERR_MSG, get_invest_distribution, None)

    def test_empty(self):
        """Проверяет выброс исключения при передаче пустого списка в
        качестве параметра"""
        self.assertRaisesRegex(ValueError, PARAM_ERR_MSG, get_invest_distribution, [])
    ...
    def test_incorrect_values(self):
        ...
        for value in incorrect_values:
            self.assertRaisesRegex(
                ValueError, PARAM_ERR_MSG, get_invest_distribution, [[1, value]]
            )
    ...
    def test_jag(self):
        ...
        self.assertRaisesRegex(
            ValueError, PARAM_ERR_MSG, get_invest_distribution, matrix
        )
