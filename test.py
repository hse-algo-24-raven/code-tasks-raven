...
from main import COST, PARAM_ERR_MSG, PATH, get_min_cost_path
...
class TestTablePath(unittest.TestCase):
    ...
    def test_single(self):
        ...
        self.assertEqual(get_min_cost_path([[1]]), {COST: 1.0, PATH: [(0, 0)]})

    def test_single_none(self):
        """Проверяет поиск кратчайшего пути в матрице размером 1*1 с ячейкой,
        запрещенной к посещению"""
        self.assertEqual(get_min_cost_path([[None]]), {COST: None, PATH: None})

    def test_double(self):
        """Проверяет поиск кратчайшего пути в матрице размером 2*2"""
        table = [[1.1, 2], [3, 4]]
        self.assertEqual(
            get_min_cost_path(table), {COST: 7.1, PATH: [(0, 0), (0, 1), (1, 1)]}
        )
    ...
    def test_double_with_none(self):
        ...
        table = [[1.1, None], [3, 4]]
        self.assertEqual(
            get_min_cost_path(table), {COST: 8.1, PATH: [(0, 0), (1, 0), (1, 1)]}
        )
    ...
    def test_negative(self):
        ...
        table = [[1.1, 2], [-3, 4]]
        self.assertEqual(
            get_min_cost_path(table), {COST: 2.1, PATH: [(0, 0), (1, 0), (1, 1)]}
        )
    ...
    def test_triple(self):
        ...
        self.assertEqual(
            ...
            {COST: 8.0, PATH: [(0, 0), (1, 0), (2, 0), (2, 1), (2, 2)]},
        )
    ...
    def test_triple_no_path(self):
        ...
        self.assertEqual(get_min_cost_path(table), {COST: None, PATH: None})
