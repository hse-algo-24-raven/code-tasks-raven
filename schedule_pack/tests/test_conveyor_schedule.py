...
class TestConveyorSchedule(unittest.TestCase):
    ...
    def test_single_task(self):
        ...
        stage1_schedule = (
            ...
            ScheduleItem(None, 1, 2, is_downtime=True),
        )
        stage2_schedule = (
            ScheduleItem(None, 0, 1, is_downtime=True),
    ...
    def test_double_task(self):
        ...
        stage1_schedule = (
            ...
            ScheduleItem(task_a, 1, 2),
            ScheduleItem(None, 3, 1, is_downtime=True),
        )
        stage2_schedule = (
            ScheduleItem(None, 0, 1, is_downtime=True),
    ...
    def test_triple_stage2_greater_only(self):
        ...
        stage1_schedule = (
            ...
            ScheduleItem(None, 9, 6, is_downtime=True),
        )
        stage2_schedule = (
            ScheduleItem(None, 0, 1, is_downtime=True),
            ScheduleItem(task_a, 1, 2),
            ...
            ScheduleItem(None, 8, 1, is_downtime=True),
    ...
    def test_triple_stage2_less_only(self):
        ...
        stage1_schedule = (
            ...
            ScheduleItem(None, 12, 3, is_downtime=True),
        )
        stage2_schedule = (
            ScheduleItem(None, 0, 6, is_downtime=True),
    ...
    def test_triple_mix(self):
        ...
        stage1_schedule = (
            ...
            ScheduleItem(None, 11, 4, is_downtime=True),
        )
        stage2_schedule = (
            ScheduleItem(None, 0, 3, is_downtime=True),
            ScheduleItem(task_b, 3, 4),
            ScheduleItem(None, 7, 2, is_downtime=True),
    ...
    def test_pentad(self):
        ...
        stage1_schedule = (
            ...
            ScheduleItem(None, 18, 2, is_downtime=True),
        )
        stage2_schedule = (
            ScheduleItem(None, 0, 2, is_downtime=True),
            ScheduleItem(task_d, 2, 3),
            ScheduleItem(task_c, 5, 5),
            ScheduleItem(task_e, 10, 4),
            ScheduleItem(task_a, 14, 3),
            ScheduleItem(None, 17, 1, is_downtime=True),
    ...
    def test_sevenfold(self):
        ...
        stage1_schedule = (
            ...
            ScheduleItem(None, 31, 1, is_downtime=True),
        )
        stage2_schedule = (
            ScheduleItem(None, 0, 2, is_downtime=True),
            ...
            ScheduleItem(None, 25, 2, is_downtime=True),
            ScheduleItem(task_a, 27, 2),
            ScheduleItem(None, 29, 2, is_downtime=True),
